  ...
  return (
    <div className="flex items-center justify-center h-full gap-2">
      ...
      <button
        onClick={onView}
        title="View Details"
        className="p-1 text-gray-500 rounded-full hover:bg-gray-200 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
      >
